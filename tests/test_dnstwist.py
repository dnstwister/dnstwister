...
def test_basic_fuzz():
    ...
    assert sorted(fuzzer.domains, key=lambda d: d['domain-name']) == [
        ...
        {'domain-name': 'www.example.br', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.buzz', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.cf', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.cn', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.co', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.com', 'fuzzer': 'Original*'},
        {'domain-name': 'www.example.de', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.fit', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.ga', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.gq', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.in', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.info', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.live', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.ml', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.net', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.org', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.ru', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.tk', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.top', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.uk', 'fuzzer': 'Other TLD'},
        {'domain-name': 'www.example.wang', 'fuzzer': 'Other TLD'},
...
def test_strange_unicode_k():
    ...
    assert len(filtered_results[1]['fuzzy_domains']) == 99
