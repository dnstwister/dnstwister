...
var dnstwistjs = (function () {
  ...
  var longestPropertyLength = function (obj) {
    var longestLength = 0
    for (var srcChar in homoglyphs) {
      var length = homoglyphs[srcChar]
  ...
  var longestSet = Math.max.apply(null, keyboardLayouts.map(function (kl) { return longestPropertyLength(keyboardLayouts[0]) }))
