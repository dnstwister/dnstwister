...
var dnstwistjs = (function () {
  ...
  var longestHomoglyph = Math.max.apply(null, Object.values(homoglyphs).map(function (h) { return h.length }))
  ...
  var longestSet = Math.max.apply(null, keyboardLayouts.map(function (kl) { return Math.max.apply(null, Object.values(keyboardLayouts[0]).map(function (k) { return k.length })) }))
